...
import { LINE_BREAK, OUTPUT_MESSAGE, JOINT_WINNER_DELIMITER, POSITION } from "./constants/Constants.js";
...
class App {
  ...
  async getWinner(race){
    ...
    OutputView.print(`${OUTPUT_MESSAGE.WINNER} ${winnerList.join(JOINT_WINNER_DELIMITER)}`);
  }
}
