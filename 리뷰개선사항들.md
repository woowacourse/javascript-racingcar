...
- [ ] addEventListener의 콜백함수를 on~ 함수로 분리한 뒤에 addEventListener에 할당하기
- [ ] view를 클래스 형태로 작성해보기
- [x] racingCar.js 에서 4를 상수로 바꾸기
- [ ] showAlert함수의 역할 변경?
- [ ] isValid를 재활용하지 않고 어떤 조건에 유효한지 자세하게 변수명에 들어나게 하기
- [ ] 입력값 유효성 확인할때 early return 하는 방법 찾아보기
- [ ] isUserInputEmpty 함수에서 alert 분리하기 (예외처리 활용)
- [ ] racingcar.spec.js 에서 display none인지로 확인하기 
- [ ] racingCarGame.js에서 renderRaceGameCountElement view로 옮기기 , handleRaceCountCheckEvent 위치 조정