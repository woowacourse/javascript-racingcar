import {BASE_URL, POSITIVE_CAR_NAME_INPUT, POSITIVE_RACE_COUNT_INPUT} from '../support/constants.js';
import {ARROW_RENDER_DELAY_TIME, RESULT_RENDER_DELAY_TIME} from '../../src/constants/constants.js';
describe('구현 결과가 요구사항과 일치해야 한다.', () => {
  ...
  it("우승자가 화면에 표시 되고 된 난 후에 alert창으로 우승자를 알려 줄 수 있다.", () => {
    ...
    cy.tick(POSITIVE_RACE_COUNT_INPUT * ARROW_RENDER_DELAY_TIME + RESULT_RENDER_DELAY_TIME).then(() => {
      expect(winnerAlertStub).to.be.called;
    })
  })
