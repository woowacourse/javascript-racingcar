...
- 정상동작
  ...
  - [ ] 사용자는 페이지에 들어오면 자동차 이름을 입력하는 폼을 본다.
  - [ ] 자동차 이름을 입력하는 칸에 자동차 이름을 입력한다.
  - [ ] 사용자는 확인 버튼을 누르고 시도할 횟수를 입력하는 폼을 본다.
  - [ ] 사용자는 시도할 횟수를 입력한다.
  - [ ] 사용자는 확인 버튼을 누르고 결과 화면을 본다 (진행결과, 최종 우승자, 다시시작하기 버튼)
  - [ ] 사용자는 다시 시작버튼을 누른다. & 사용자는 게임의 첫 화면으로 돌아간다. ( 시도횟수, 결과 화면이 사라진다. )

- 예외상황
  - 자동차 이름
    - [ ] 자동차 이름이 5자 이상인 경우 ⇒ Error
    - [ ] 자동차 이름이 공백인 경우 ⇒ Error
    - [ ] 자동차 이름이 중복되는 경우
      - Error
      - ~~뒤에 숫자를 넣어주는 식으로 구분.~~
      - 대소문자 구분 함.
