...
describe("RacingGame 클래스 테스트", () => {
  ...
  test("2개의 자동차와 3번의 시도 횟수, 두 자동차 모두 3번 연속 이동", () => {
    ...
    const resultOfFirstTurn = racingGame.getCarsResultOfOneTurn();

    racingGame.raceOneTurn();
    const resultOfSecondTurn = racingGame.getCarsResultOfOneTurn();

    racingGame.raceOneTurn();
    const resultOfThirdTurn = racingGame.getCarsResultOfOneTurn();
